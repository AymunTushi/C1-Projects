    ...
    <div id="sidebar-menu">
      ...
      <ul className="metismenu list-unstyled" id="side-menu">
        ...
        <li className={activemenu=="Dashboard" ? "mm-active" : ""}>
          <a href="javascript: void(0);" onClick={()=>setActiveMenu("Dashboard")} className="waves-effect">
        ...
        <li className={activemenu=="Services" ? "mm-active" : ""}>
          <a href="javascript: void(0);" onClick={()=>setActiveMenu(activemenu=="Services" ? "": "Services")} className=" waves-effect has-arrow">
          ...
          <ul className={
            ...
            <li><a href="ecommerce-products.html" key="t-products">Service-1</a></li>
            <li><a href="ecommerce-product-detail.html" key="t-product-detail">Service-2</a></li>
        ...
        <li className={activemenu=="Ticket" ? "mm-active" : ""}>
          <a href="javascript: void(0);" onClick={()=>setActiveMenu("Ticket")} className="waves-effect">
        ...
        <li className={activemenu=="Billing" ? "mm-active" : ""}>
          <a href="javascript: void(0);" onClick={()=>setActiveMenu("Billing")} className=" waves-effect">
        ...
        <li className={activemenu=="Notification" ? "mm-active" : ""}>
          <a href="javascript: void(0);" onClick={()=>setActiveMenu("Notification")} className="waves-effect">
        ...
        <li className={activemenu=="Notice" ? "mm-active" : ""}>
          <a href="javascript: void(0);" onClick={()=>setActiveMenu("Notice")} className="waves-effect">
        ...
        <li className={activemenu=="Assign Contact" ? "mm-active" : ""}>
          <a href="javascript: void(0);" onClick={()=>setActiveMenu("Assign Contact")} className="waves-effect">
        ...
        <li className={activemenu=="Technical Information" ? "mm-active" : ""}>
          <a href="javascript: void(0);" onClick={()=>setActiveMenu("Technical Information")} className="waves-effect">
            <i className="bx bx-briefcase-alt" />
            <span key="t-jobs">Technical Information</span>
          </a>
          {/* <ul className="sub-menu" aria-expanded="false">
            ...
            <li>
              <a href="javascript: void(0);" className="has-arrow" key="t-candidate">Candidate</a>
              <ul className="sub-menu" aria-expanded="true">
